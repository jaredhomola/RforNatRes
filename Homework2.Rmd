...
3. Rename the file to include your last name (lastName_Homework2.rmd). Turn in the knitted HTML and this R markdown document via email by class time next Wednesday (Feb 9).  
...
**Questions 2: Analyze the knz_bison data set of the lterdatasampler package**  
Questions 2a. What is the mean animal_weight of the bison with animal_code "A16"?  
```{r}
# Answer 2a

```

Question 2b. How many years was the bison with animal_code "A16" observed? Be sure your code gives the exact answer by running it (i.e., do not transcript a value on a table to get the answer). 
```{r}
# Answer 2b
...
**Question 3: Interpreting and commenting**  
Question 3a. Appropriately comment the code below to describe each process being accomplished. Modify the code as we discussed in class to improve readability (spaces, new lines, etc.).   
```{r}
...
**Question 4: Modify appearance of your R markdown document.**   
