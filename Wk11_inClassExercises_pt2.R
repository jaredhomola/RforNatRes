...
### Data at https://raw.githubusercontent.com/jaredhomola/RforNatRes/gh-pages/gobyData.txt
...
### Raster data at: https://github.com/jaredhomola/RforNatRes/blob/gh-pages/southernGbBathymetry.tif?raw=true
southGB <- raster()

### Alternative Wisconsin outline at: https://data-wi-dnr.opendata.arcgis.com/
